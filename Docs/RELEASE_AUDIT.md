...
| GitHub static verification | `Release Static Checks` passed for device evidence branch-head commit `ec3be40`; run `25393247310`: `https://github.com/perlantir/stormblocks/actions/runs/25393247310`. Branch-head status should be checked after any follow-up docs-only commit. | Pass |
