...
| GitHub static verification | `Release Static Checks` passed for accessibility VFX branch-head commit `d078c0d`; run `25393020902`: `https://github.com/perlantir/stormblocks/actions/runs/25393020902`. Branch-head status should be checked after any follow-up docs-only commit. | Pass |
