...
| Physical QA handoff | `Docs/PHYSICAL_QA_RUNBOOK.md`, `Docs/FIVE_RUN_QA_SCORECARD.md`, and `Scripts/device_qa_session.sh` define launch, structured five-run QA, Game Center, TestFlight, and profiling steps. | Local pass; physical execution pending |
