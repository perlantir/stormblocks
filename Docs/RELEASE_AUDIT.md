...
| GitHub static verification | `Release Static Checks` passed for running Game Performance trace evidence commit `ec3c9d6`; run `25393995877`: `https://github.com/perlantir/stormblocks/actions/runs/25393995877`. Branch-head status should be refreshed after any follow-up docs-only commit. | Pass |
