...
status() {
  ...
  require_nunit_pass "$UNITY_PROJECT/playmode-results.xml" 8
  require_log_contains "$UNITY_PROJECT/playmode-results.xml" "Storm Blocks mobile budget renderers=442 triangles=161544 audioListeners=1 canvases=1"
