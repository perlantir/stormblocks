...
audit_local_evidence() {
  ...
  require_grep "$UNITY_PROJECT/playmode-results.xml" "Storm Blocks mobile budget renderers=365 triangles=136308 audioListeners=1 canvases=1" "PlayMode mobile budget baseline is current"
